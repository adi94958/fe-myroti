...
const FormTambahKeuangan = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:8000/api/keuangan/registrasi', newUser)
      Swal.fire({
        title: 'Berhasil',
    ...
    <>
      <CCard>
        <CForm onSubmit={handleSubmit}>
          <CCardHeader>Form Tambah Akun Keuangan</CCardHeader>
          <CCardBody>
            <CRow>
              <CCol xs={12}>
...
export default FormTambahKeuangan
